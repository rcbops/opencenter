...
class NodeCreateTests(unittest2.TestCase):
    ...
    def test_create_node_with_name_config_and_no_cluster_role(self):
        data = {'name': self.name,
                'config': self.attribs}
        resp = self.app.post('/nodes/',
                             content_type=self.content_type,
    ...
    def test_create_node_with_name_config_cluster_and_no_role(self):
        data = {'name': self.name,
    ...
    def test_create_node_with_name_config_cluster_role(self):
        data = {'name': self.name,
                'cluster_id': self.clus1_id,
                'role': 'test-role',
                'config': self.attribs}
